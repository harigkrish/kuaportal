...
const AuaDemographicPartial = () => {
  ...
  const {udiNum, aadhaarName, machingValue}=uidData;
        ...
        <table>
          <tr style={{backgroundColor:"#2A5537" , color:"ButtonFace"}}>
           ...
           <tr>
            ...
            <tr>
                <label> <b>UID/VID  <color style={{color:"red"}}>*</color></b></label>
            ...
            <tr>
                <div className="form-group">
                   <label><b>Name <color style={{color:"red"}}>*</color></b></label>
                   <input type="text" className="form-control form-control-lg" 
            ...
            <tr>
                <div className="form-group">
                  <label><b>Matching Stratagy <color style={{color:"red"}}>*</color></b></label>
                  
                
                  <input type="radio" value="exact" 
                      onChange={e => handleChange(e)} name="matching" />
                      <label for="aua" >Exact</label> &nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <div className="form-group">
                  <label><b>Matching Value <color style={{color:"red"}}>*</color> </b></label>
                  <input type="text" className="form-control form-control-lg" 
                    placeholder="Enter matching value"  id="machingValue" name="machingValue" value={machingValue}
                    style={{width:"340px"}}  onChange={e => onInputChange(e)}
                  />
                </div>
            </tr>
...
export default AuaDemographicPartial
